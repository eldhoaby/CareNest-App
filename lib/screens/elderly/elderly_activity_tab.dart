...
// ═══════════════════════════════════════════════════════════════════════════
// ELDERLY ACTIVITY TAB — Premium Health Analytics Dashboard
// ═══════════════════════════════════════════════════════════════════════════

class ElderlyActivityTab extends StatefulWidget {
  final String userId;

  const ElderlyActivityTab({super.key, required this.userId});

  @override
  State<ElderlyActivityTab> createState() => _ElderlyActivityTabState();
}

class _ElderlyActivityTabState extends State<ElderlyActivityTab>
